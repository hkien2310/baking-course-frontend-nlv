...
function documentReadyInit() {
	...
	//comingsoon counter
	if ($().countdown) {
		var $counter = $('#comingsoon-countdown, #flex-countdown, #flex-countdown2, #flex-countdown3');
...
function windowLoadInit() {
	...
	//owl carousel//
	////////////////
	window.mukaInitOwlCarousel = function($elements) {
	...
	window.mukaInitOwlCarousel($('.owl-carousel')); //eof owl-carousel
...
// EXPORT TO GLOBAL SCOPE FOR REACT ROUTER
window.documentReadyInit = documentReadyInit;
window.windowLoadInit = windowLoadInit;
